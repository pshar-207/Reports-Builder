...
export default function TradeDoublerMMads() {
  ...
  const mapTradeDoublerRow = (row, campaign) => {
    ...
    if (campaign.Id === 1388 && campaign.name === "Caledonian Travel") {
      ...
      campaign.Id === 2490 &&
      campaign.name ===
        "EuroParcs | Unique holiday parks in the Netherlands, Belgium, Luxembourg, Austria and Germany"
    ) {
      return {
        p1: row["epi"].split("_")[1],
        created: row["timeOfTransaction"],
  ...
  return (
    <div style={{ padding: "20px" }}>
      <h2>📁 Upload TradeDoubler MMads Report</h2>
